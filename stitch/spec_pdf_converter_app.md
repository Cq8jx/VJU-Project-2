...
*   **Filename Strategy for Merged**:
    *   Format: `[ID]_[Title]_[Lang].[ext]` (e.g., `50_Quality Plan_EN.docx`).
...
Analyze this image (Page 1 of a document). Return a JSON object with:
{
  ...
  "id": string | null, // See ID RULES below.
  ...
  "related_ids": string[], // IDs found in "Pursuant to..." or "Replacing..."
  "tags": string[] 
}
...
3. RELATED IDS: Extract any Document IDs cited in "Pursuant to..." (Basis) or "Replacing..." (Superseded) into `related_ids` array.
...
- **対象フィールド**: `id`, `doc_id`, `part_id`, `replace_id`, `related_ids`, `signer`, `issuer`, `tags`
- **内容**: 
